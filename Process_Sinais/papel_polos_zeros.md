...
Anteriormente (tópico: [[Funções Trasferência](funcao_transferencia.html)]) foi mostrado como a localização dos pólos e zeros afeta os contornos da superfície $H(z)$ de um sistema, com pólos associados a 'cones' na superfície $H(z)$ e zeros associados a 'cones invertidos'. 
